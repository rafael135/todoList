<tr data-task-id="{{$task["id"]}}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-opacity-95">
    <td class="w-4 p-3">
    ...
    <td class="px-5 py-3">
        <div class="flex justify-around items-center">
            ...
            <a href="#" type="button" data-task-id="{{$task["id"]}}" data-modal-target="deleteModal" data-modal-toggle="deleteModal" onclick="setDeleteId(this)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
