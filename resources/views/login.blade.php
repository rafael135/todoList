...
@component("partials.body")
    <form class="form-auth rounded-xl shadow-lg bg-slate-800 pb-4 pt-0 bg-opacity-95" method="POST" action="{{route("user.loginAction")}}">
        @csrf
        ...
        <div class="flex mb-2 mx-6">
            <button type="submit" class="flex-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        </div>
