            ...
            <div id="tasks-table" class="bg-slate-800 bg-gradient-to-b from-slate-800 from-60% to-slate-900 w-full md:rounded-t-lg">
                <div class="flex flex-col md:flex-row p-3">
                    ...
                    <div class="md:ms-auto">
                        <form method="GET" action="{{route('user.tasks')}}" class="flex items-center relative">
                            ...
                            <input type="text" id="table-search-tasks" name="search" value="{{($search != false) ? $search : ''}}" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full md:max-w-fit" placeholder="Procurar por Tarefas">
                        </form>
                    </div>
                </div>

                <div id="tasks-head" class="flex bg-gray-700 text-gray-300 text-lg">
                    <div class="task-color w-20 py-2 text-center font-bold text-lg border-r border-slate-600">
                        Status
                    </div>
                    ...
                    <div class="task-created_at py-2 flex-1 text-center font-bold text-lg border-r border-slate-600 hidden md:block">
                        Criado em
                    </div>

                    <div class="task-due_date py-2 flex-1 text-center font-bold text-lg border-r border-slate-600 hidden md:block">
                        Válido até
                    </div>

                    <div class="task-actions py-2 w-40 text-center font-bold text-lg">
                        Ações
                    </div>
                </div>
            ...
            <div id="showTask-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full max-w-lg max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow pb-4 dark:bg-slate-800 bg-gradient-to-t from-slate-800 from-60% to-slate-900">
                        ...
                        <div class="flex">
                            <div class="flex-1">
                                <div class="text-lg font-bold mb-0 mt-3 px-4 text-slate-50">Criado em:</div>
                                <div id="showTaskCreatedAt" class="px-2 mx-4 text-slate-100"></div>
                            </div>
                            <div class="flex-1">
                                <div class="text-lg font-bold mb-0 mt-3 px-4 text-slate-50">Validade:</div>
