...
@component("partials.body")
        ...
        <div class="relative w-full mt-3 shadow-md sm:rounded-lg">
            <div class="flex items-center justify-end rounded-t-lg py-3 px-3 bg-white dark:bg-slate-800">
                ...
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <button data-modal-hide="deleteModal" type="button" onclick="deleteTask()" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                Sim
                            </button>
