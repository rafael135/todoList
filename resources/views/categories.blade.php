...
@component("partials.body")
        ...
        <div class="relative w-full mt-3 shadow-md sm:rounded-lg">
            <div id="categories-table" class="bg-slate-800 sm:rounded-t-lg">
                <div class="flex p-3">
                    <div class="">
                        <!-- Modal Create Toggle -->
                ...
                <div id="categories-head" class="flex bg-gray-700 text-gray-300 text-lg">
                    <div class="category-color w-24 py-2 text-center font-bold text-lg border-r border-slate-600">
                        Cor
                    </div>
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <form action="{{route("category.edit")}}" method="POST" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="editCategoryModal">
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <form action="{{route("category.create")}}" method="POST" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="createCategoryModal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>  
                        </button>
                    </div>
                    <!-- Modal body -->
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <button data-modal-hide="deleteCategoryModal" type="button" onclick="deleteTask()" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Sim
                        </button>
